    ...
    <main class="conteudo">
      ...
      <section class="info-ataque">
        ...
        <p class="texto-descricao">
          As redes de internet são as "estradas" que conectam seus aparelhos ao mundo digital. Em casa, é essencial proteger sua rede Wi-Fi com uma senha forte e mantê-la atualizada. Redes Wi-Fi públicas, como as de shoppings, aeroportos e restaurantes, podem ser monitoradas por pessoas mal-intencionadas. Evite acessar bancos ou digitar senhas quando estiver conectado a elas. Sempre que possível, prefira usar os dados móveis do seu celular para acessar informações sensíveis fora de casa.
        </p>
